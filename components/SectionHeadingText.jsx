...
const SectionHeadingText = () => {
  return (
    <div className="w-full h-full flex flex-col gap-y-8 justify-start max-[800px]:justify-center text-start max-[800px]:pl-4 pl-20">
      ...
      <p className="head_text_light  dark:head_text font-semibold dark:font-semibold text-start text-[1rem] dark:text-[1rem] leading-6 text-slate-500 dark:text-start" style={{lineHeight:"1.67rem"}}>
