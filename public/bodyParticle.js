...
//   engineSetup();
//   frameRate(250);
//   bx = new Box(200, 250, 200, 10, { isStatic: true, angle: radians(40) });
//   bx2 = new Box(290, 450, 200, 10, { isStatic: true, angle: 56 });
// }
...
//   });
//   circs.push(
//     new Particle(mouseX, mouseY, random(7), { friction: 0, restitution: 0.41 })
//   );
...
//   isOffScreen() {
//     return (
//       this.y > height + this.height + 100 || this.x > width + this.width + 100
//     );
//   }
//   destroy() {
