...
const Home = () => {
  ...
  return (
    <section className=" bg_color overflow-x-hidden   w-full flex flex-col object-cover items-center  h-[100rem] md:pt-10">
      ...
      <div className="sign max-[750px]:top-44  min-[760px]:top-56">
      ...
      <input
        type="text"
        className="input relative min-[900px]:hidden max-[900px]:top-[2rem] max-[420px]:w-72  w-96 px-4 py-2 bg-black rounded-md shadow-sm border border-gray-300 focus:ring-indigo-500 focus:border-indigo-500"
        placeholder="Search..."
      />
      <br className="" />
      <br className="" />
